...
%
% In practice, the heuristics may fail to apply or may
% go into infinite ``matching loops'' leaving programmers
% with little clue of how to proceed~\citep{Leino16}.
%
% Indeed, according to the authors of Dafny, these heuristics
% are unpredictable and suffer from a ``butterfly effect''
% where modification in a part of the program changes the
% outcome of verification in other part \cite{Leino16}.

\mypara{Refinement Reflection}
%
