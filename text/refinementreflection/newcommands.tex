...
\renewcommand\pred{\ensuremath{r}\xspace}
...
\renewcommand\slam[2]{\ensuremath{\smtlamname{}{}\ {#1}\ {#2}}\xspace}
...
\renewcommand\corelan{\ensuremath{\texorpdfstring{\lambda^{R}}{lamR}}\xspace}
\providecommand\undeclang{\ensuremath{\lambda^{U}}\xspace}
% \providecommand\smtlan{\ensuremath{\texorpdfstring{\lambda^{\mathit{SMT}}}{lamSMT}}\xspace}
\newcommand\smtlan{\ensuremath{\texorpdfstring{\lambda^{\mathit{S}}}{lamS}}\xspace}
...
\renewcommand\subst[2]{\ensuremath{[{#2}/{#1}]}}
\renewcommand{\SUBST}[3]{{#1}\subst{#2}{#3}}
